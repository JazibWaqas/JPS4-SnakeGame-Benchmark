# makes the figures for the progress report
...
# numbers pulled from run_preliminary_benchmark.py (seed=42, 24 trials)
...
# fig 2: ratio vs dijkstra
fig2, ax = plt.subplots(figsize=(3.5, 2.6))
dij = data["Dijkstra"]["exp"]
for alg in ["A*", "JPS4"]:
    ratios = [data[alg]["exp"][i] / dij[i] * 100 for i in range(len(densities))]
...
# fig 3: little schematic of jps pruning
...
astar_cells = [(1, 2), (1, 3), (1, 4), (2, 2), (3, 2), (3, 3), (3, 4), (3, 5),
